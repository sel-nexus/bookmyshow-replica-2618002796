...
export function ConfirmationCard({ booking }: { booking: BookingConfirmation }): React.JSX.Element {
  return (
    <section className="auth-panel" aria-labelledby="confirmation-title">
      <p className="eyebrow">BOOKING CONFIRMED</p>
      <h1 id="confirmation-title">Congratulations!</h1>
      <p>
        <strong>Confirmation:</strong> {booking.confirmationId}
      </p>
      <p>
      ...
      <p>
        <strong>Total:</strong> Rs. {booking.totalPricePaise / 100}
      </p>
    </section>
  );
}
